export class HttpError<T extends keyof typeof HttpError['_httpStatusName']> extends Error {
	private static _httpStatusName = {
		400: 'BadRequest',
		401: 'Unauthorized',
		//402: 'PaymentRequired',
		403: 'Forbidden',
	...
	constructor(statusCode: T, message?: string) {
		...
		this.name = HttpError['_httpStatusName'][statusCode];
